 ...
 while (strtotime($date_from) < strtotime($end_date)) 
		 {
			 ...
			 ?>
			  <h3><?php echo date('l, j F, Y', strtotime($date_from))?> - <?php echo  esc_attr($day_num_of_week)?></h3>
			  
			  ?>
              
			  <div class="bup-time-slots-divisor" id="bup-time-sl-div-<?php echo esc_attr($cdiv)?>">
 ...
 foreach($time_slots as $slot)
			 {
				...
				<li id="bup-time-slot-hour-range-<?php echo esc_attr($cdiv)?>-<?php echo esc_attr($cdiv_range)?>">
				...
				<?php esc_html_e('Book Appointment','booking-ultra-pro')?></span></button>
                 </span>
